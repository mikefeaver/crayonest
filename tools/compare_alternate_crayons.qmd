...
Choose the networks to compare in /dep/results_log/\<crayon_name1\>
...
route1 <- st_read(paste(results_folder, crayon1, "/shapes.geojson", sep = ""))
route2 <- st_read(paste(results_folder, crayon2, "/shapes.geojson", sep = ""))
stops1 <- st_read(paste(results_folder, crayon1, "/stops.geojson", sep = ""))
stops2 <- st_read(paste(results_folder, crayon2, "/stops.geojson", sep = ""))
...
```{r}
ggsave(
  paste(results_folder, "compare-", crayon1, "-", crayon2, "/transit_job_access_comparison_plot.png", sep = ""),
  units = "in", 
  width = 10, 
  height = 5.8, 
  dpi = 400
...
write.csv(access_sf, paste(results_folder, "compare-", crayon1, "-", crayon2, "/transit_job_access_comparison.csv", sep = ""), row.names=FALSE)
```
