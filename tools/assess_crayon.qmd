...
ggsave(
  paste(results_folder, crayon_name, "/transit_job_accessibility_map.png", sep = ""),
  units = "in", 
  width = 10, 
  height = 5.8, 
  dpi = 400
...
ggsave(
  paste(results_folder, crayon_name, "/transit_job_accessibility_plot.png", sep = ""),
  units = "in", 
  width = 10, 
  height = 5.8, 
  dpi = 400
...
write_csv(access, path = paste(results_folder, crayon_name, "/transit_job_accessibility.csv", sep = ""))
```
